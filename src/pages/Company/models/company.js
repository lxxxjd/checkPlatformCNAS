...
import {getCNASCheckFourCertCodeListInfo, getAllCNASCheckDetail} from '@/services/cnas';
...
export default {
  ...
  reducers: {
    getCNASCheckDetail(state, { payload }) {
      return {
        ...state,
        CNASCheckDetail: payload.data,
      };
    },
